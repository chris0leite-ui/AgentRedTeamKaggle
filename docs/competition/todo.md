...
## In flight
- [ ] **E2 — baseline measurement:** submit the single-post primitive with SMOKE_MODE **off**; read
  the real per-model score. _Blocked on:_ v1 smoke score posting. (4 submissions left today.)
